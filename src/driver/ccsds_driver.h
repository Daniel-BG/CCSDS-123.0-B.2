...
#define CCSDS_REG_CFG_FULL_PREDICTION_LOCALADDR		36
...
#define CCSDS_REG_CFG_WIDE_SUM_LOCALADDR			148
#define CCSDS_REG_CFG_NEIGHBOR_SUM_LOCALADDR		152
#define CCSDS_REG_CFG_SMID_LOCALADDR				156
